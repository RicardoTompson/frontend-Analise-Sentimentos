...
import { backendApiBase, examples, sentimentApiPath } from "./constants";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-2xl font-semibold text-slate-950">Como você está se sentindo?</h2>
          <p className="mt-2 text-sm leading-6 text-slate-600">
            O backend padrão esperado é <span className="font-semibold text-slate-900">{backendApiBase}</span>.
          </p>
        </div>
